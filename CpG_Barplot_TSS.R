...
B3$UCSC_RefGene_Group <- as.character(B3$UCSC_RefGene_Group)
C1$UCSC_RefGene_Group <- as.character(C1$UCSC_RefGene_Group)
#A4$UCSC_RefGene_Group <- as.character(A4$UCSC_RefGene_Group)
C2$UCSC_RefGene_Group <- as.character(C2$UCSC_RefGene_Group)
B4$UCSC_RefGene_Group <- as.character(B4$UCSC_RefGene_Group)


AllB3=count(B3$UCSC_RefGene_Group)
AllC1=count(C1$UCSC_RefGene_Group)
#AllA4=count(A4$UCSC_RefGene_Group)
AllC2=count(C2$UCSC_RefGene_Group)
AllB4=count(B4$UCSC_RefGene_Group)
...
B4_hyper_count=count(B4_Hyper$UCSC_RefGene_Group)
B4_hypo_count=count(B4_Hypo$UCSC_RefGene_Group)
...
barplot(as.matrix(df), col=coul, space=0.5, font.axis=2, ylab="portion", xpd = FALSE, main="CpGs Status -By Genomic Context", cex.axis=1.0, cex.names=0.8)
